...
cp ~/.local/share/flamelet/tenants/london/run.py ~/.config/flamelet/tenants/production/
cp ~/.local/share/flamelet/tenants/london/inventory.py ~/.config/flamelet/tenants/production/
cp ~/.local/share/flamelet/tenants/london/vars/*.py ~/.config/flamelet/tenants/production/vars/
...
mkdir -p ~/.config/flamelet/tenants/london/vars/{location,hosts}

# Copy template files
cp core/tenants/london/{run.py,inventory.py} ~/.config/flamelet/tenants/london/
cp core/tenants/london/vars/*.py ~/.config/flamelet/tenants/london/vars/
```
...
~/.config/flamelet/tenants/london/run.py --dry --limit controller.paris

# Run specific tasks
~/.config/flamelet/tenants/london/run.py --task users
~/.config/flamelet/tenants/london/run.py --task packages

# Run all tasks
~/.config/flamelet/tenants/london/run.py
```
