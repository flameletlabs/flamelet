...
1. **k3s** — 4 of 25 hosts need it (k3s.london + 3 workers in newyork)
2. **virtualization** — 4 hypervisor hosts (virt*, virt-*.newyork)
3. **storage** — 1 NAS host (nas-01.tokyo)
